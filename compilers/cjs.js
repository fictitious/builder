...
var STRING = $traceurRuntime.getModule('traceur@0.0.95/src/syntax/TokenType.js').STRING;
var LiteralExpression = $traceurRuntime.getModule('traceur@0.0.95/src/syntax/trees/ParseTrees.js').LiteralExpression;
var LiteralToken = $traceurRuntime.getModule('traceur@0.0.95/src/syntax/LiteralToken.js').LiteralToken;
var IdentifierExpression = $traceurRuntime.getModule('traceur@0.0.95/src/syntax/trees/ParseTrees.js').IdentifierExpression;
var IdentifierToken = $traceurRuntime.getModule('traceur@0.0.95/src/syntax/IdentifierToken.js').IdentifierToken;
var BindingIdentifier = $traceurRuntime.getModule('traceur@0.0.95/src/syntax/trees/ParseTrees.js').BindingIdentifier;
var createUseStrictDirective = $traceurRuntime.getModule('traceur@0.0.95/src/codegeneration/ParseTreeFactory.js').createUseStrictDirective;
